...
function DAppProviderWithConfig(_a) {
    ...
    var _b = config_1.useConfig(), multicallAddresses = _b.multicallAddresses, networks = _b.networks;
    var defaultAddresses = react_1.useMemo(function () { return getMulticallAddresses(networks); }, [networks]);
